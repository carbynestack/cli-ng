...
public class UpdateTagCommandTest {
    static class IdAndTagsTests {
        ...
        @ParameterizedTest
        @CommandSource(args = {"amphora", "tags", "update", "first=1",
        ...
        void execute(CommandResult result) {
            ...
            assertThat(result.out())
                    .contains("The tag update was successful.");
        }
    }
    ...
    static class FailingCreationTests {
        ...
        @ParameterizedTest
        @CommandSource(args = {"amphora", "tags", "update",
                "--config=src/test/resources/amphora-config.json"})
    ...
    private record AmphoraClientMock(boolean failure, UUID id, String key, String value,
        ...
        @Override
        public void updateTag(UUID uuid, Tag tag) throws AmphoraClientException {
